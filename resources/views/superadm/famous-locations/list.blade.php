            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="{{ route('famous-locations.add') }}" class="btn btn-sm btn-outline-primary" >Add New Famous Locations</a>
                    </div>
                            ...
                            <tbody>
                                @foreach ($famouslocations as $i => $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('famous-locations.edit', base64_encode($data->id)) }}"
                                                class="btn btn-sm btn-outline-primary">Edit</a>

                                            <form action="{{ route('famous-locations.delete') }}" method="POST"
