                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    <li><a href="{{ route('superadmin.change-password') }}"><i class="fa fa-key"></i> Change
                                            password</a></li>
                                    <li><a href="{{ route('superadmin.logout') }}"><i class="fa fa-power-off"></i> Logout</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="{{ route('superadmin.dashboard-admin') }}"> <i class="mdi mdi-view-dashboard"></i><span>Dashboard
                                </span></a>
                        </li>

                         <li> <a href="{{ route('superadmin.admin-gp.list') }}"> <i class="mdi mdi-view-dashboard"></i><span>GP List
                                </span></a>
                        </li>

                        

                        <li> <a href="{{ route('superadmin.logout') }}"> <i class="mdi mdi-account-group"></i><span>Logout
                                </span></a>
                        </li>
