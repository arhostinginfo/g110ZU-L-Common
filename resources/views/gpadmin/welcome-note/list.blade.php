            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3 d-flex justify-content-end">
                        <a href="{{ route('gpadmin.welcome-note.create') }}" class="btn btn-sm btn-outline-primary" >Add Welcome Note</a>
                    </div>
                            ...
                            <tbody>
                                @foreach ($welcomenote as $key => $welcomnote)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('gpadmin.welcome-note.updatestatus') }}" method="POST"
                                        ...
                                        <td>
                                            <a href="{{ route('gpadmin.welcome-note.edit', base64_encode($welcomnote->id)) }}"
                                                class="btn btn-sm btn-outline-primary">Edit</a>
                                            <form action="{{ route('gpadmin.welcome-note.delete') }}" method="POST"
                                                class="d-inline-block delete-form">
                                                @csrf
