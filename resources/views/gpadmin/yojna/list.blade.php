                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif($data->type_attachment == 'Link')
                                                <a class="btn btn-primary btn-sm" href="{{ $data->attachment_link }}" target="_blank">इथे क्लिक करा</a>
                                        ...
                                        <td>
                                            <form action="{{ route('gpadmin.yojna.updatestatus') }}" method="POST" class="d-inline-block">
                                                @csrf
                                                <label class="switch">
