        ...
        <div class="col-lg-6 col-md-8 mx-auto">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('gpadmin.yojna.save') }}" method="POST" enctype="multipart/form-data" class="mt-3">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="type_attachment" id="type_attachment"
                                ...
                                <option value="PDF" {{ old('type_attachment') == 'PDF' ? 'selected' : '' }}>PDF</option>
                                <option value="Image" {{ old('type_attachment') == 'Image' ? 'selected' : '' }}>Image</option>
                                <option value="Link" {{ old('type_attachment') == 'Link' ? 'selected' : '' }}>Link</option>
                            </select>
