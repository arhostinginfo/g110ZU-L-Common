...
class GallaryController extends Controller
{
    ...
    public function save(Request $request)
    {
        ...
        return redirect()->route('gallary.list')->with('success', 'Officer added successfully.');
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('gallary.list')->with('success', 'Officer updated successfully.');
    }
    ...
    public function delete(Request $request)
    {
        ...
        return redirect()->route('gallary.list')->with('success', 'Officer deleted successfully.');
    }
}
