...
class PDFUploadController extends Controller
{
    ...
    public function __construct()
   {
    ...
    public function edit($encodedId)
    {
        ...
        $gallaries = PDFUpload::where('id', $id)
    ...
    public function delete(Request $request)
    {
        ...
        return redirect()->route('gpadmin.pdfupload.list')->with('success', 'PDF deleted successfully.');
    }
    ...
    public function updateStatus(Request $request)
    {
        try {
            ...
            PDFUpload::where('id', $id)
                ->where('gp_user_id', $this->gp_user_id)
                ->update(['is_active' => $request->is_active]);
            return redirect()->route('gpadmin.pdfupload.list')->with('success', 'Status updated successfully.');
        } catch (\Exception $e) {
            \Log::error('PDFUploadController@updateStatus: ' . $e->getMessage());
